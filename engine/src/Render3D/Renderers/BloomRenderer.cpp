...
BloomRenderer::BloomRenderer(Viewport &viewport, QuadRenderer &quadRenderer)
    ...
    auto fragmentSrc = GLSLPreprocessor::preprocess("./shaders/pass/blur-gaussian.fragment.glsl").sourceCode;
    m_BlurShader = Shader(vertexSrc, fragmentSrc);

    fragmentSrc = GLSLPreprocessor::preprocess("./shaders/pass/common/textured.fragment.glsl").sourceCode;
    m_BlitShader = Shader(vertexSrc, fragmentSrc);

    fragmentSrc = GLSLPreprocessor::preprocess("./shaders/pass/bloom.fragment.glsl").sourceCode;
...
void BloomRenderer::draw(RenderSettings &settings, Texture inputColorBuffer, Texture exposureColorBuffer,
