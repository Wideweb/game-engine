...
class ModelInstanceBatch {
  public:
    ...
    void create(uint32_t id, glm::mat4 position) {
    ...
    void update(uint32_t id, const glm::mat4& position) {
    ...
    void update(uint32_t id, const std::vector<glm::mat4>& joints) {
